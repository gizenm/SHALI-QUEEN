...
◇───────────────◇
🔥 **Removed  by** : [ 🎨 Imᥲgᥱ Tooᥣs Bot](https://t.me/GIZAKOANDSHIZU)
⚡️ **Powered By**  : `【NOINBOX™】`
◇───────────────◇
©2021[【NO™】 team ](https://t.me/GIZAKOANDSHIZU) **All Right Reserved**⚠️️
"""    
...
BUTTONS = InlineKeyboardMarkup(	
      [	
        [	
        InlineKeyboardButton(text="➕ Add me to your group ➕", url=f"http://t.me/SHALI_QUEEN_BOT?startgroup=botstart") 	
        ],	
        [	
         InlineKeyboardButton(text="🗣️Join my updates ", url=f"https://t.me/GIZAKOANDSHIZU") 	
        ]	
      ]      	
    )    
...
async def _(event):
    ...
    if "image" in contentType:
        ...
        await gg.edit(
            "remove.bg API returned Errors. Please report to @NO_INBOX\n`{}` ".format(
