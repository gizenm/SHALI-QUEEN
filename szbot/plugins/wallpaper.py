...
◇───────────────◇
👨‍💻 **Generated By** : [SHALI_QUEEN](https://t.me/GIZAKOANDSHIZU)
🙋‍♂️ **Requestor** : {}
⚡️ **Powered By **  : [SHALI_QUEEN](https://t.me/GIZAKOANDSHIZU)
◇───────────────◇️  
"""
...
async def logo(client, message):
 ...
 try:
    ...
    await client.send_message(message.chat.id, f'An error occurred! Report this @NO_INBOX, {e}')
