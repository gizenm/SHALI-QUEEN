...
BUTTON = InlineKeyboardMarkup(
      [
        [
        InlineKeyboardButton(text="➕ Add me to your group ➕", url=f"https://t.me/GIZAKOANDSHIZU?startgroup=botstart") 
        ],
        [
...
◇───────────────◇
🔥 **Created by** : [🎨 Imᥲgᥱ Tooᥣs Bot](https://t.me/GIZAKOANDSHIZU)
⚡️ **Powered By**  : `【NO~INBOX™】´
◇───────────────◇
©2021【NO™】 team  **All Right Reserved**⚠️️
"""
